...
(function($PS) {
  ...
  exports["monoidHalogenM"] = monoidHalogenM;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.API.Internal"] = $PS["Roll.API.Internal"] || {};
  var exports = $PS["Roll.API.Internal"];
  ...
  var ParsingError = (function () {
      function ParsingError(value0) {
          this.value0 = value0;
      };
      ParsingError.create = function (value0) {
          return new ParsingError(value0);
      };
      return ParsingError;
  })();
  ...
  var get = function (dictReadForeign) {
      return function (url) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(AffjaxError.create))(Affjax.get(Affjax_ResponseFormat.string)(url)))((function () {
              var $2 = Control_Monad_Except_Trans.except(Effect_Aff.applicativeAff);
              var $3 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(ParsingError.create);
              var $4 = Simple_JSON.readJSON(dictReadForeign);
              return function ($5) {
                  return $2($3($4((function (v) {
                      return v.body;
                  })($5))));
              };
          })());
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.API.Category"] = $PS["Roll.API.Category"] || {};
  var exports = $PS["Roll.API.Category"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Roll_API_Internal = $PS["Roll.API.Internal"];
  var Simple_JSON = $PS["Simple.JSON"];                
  var getProducts = function (slug) {
      return Roll_API_Internal.get(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "description";
          ...
          return "slug";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()())()())))("/category/" + (slug + "/products"));
  };
  var getBySlug = function (slug) {
      return Roll_API_Internal.get(Simple_JSON.readString)("/category/" + slug);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.Component.Internal"] = $PS["Roll.Component.Internal"] || {};
  var exports = $PS["Roll.Component.Internal"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Data_Either = $PS["Data.Either"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var Web_HTML_Window = $PS["Web.HTML.Window"];                
  var href = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.location))(Web_HTML_Location.href);
  var getSlug = (function () {
      var go = (function () {
          var $0 = Data_Newtype.unwrap(Data_Maybe_Last.newtypeLast);
          var $1 = Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Maybe_Last.monoidLast)(function ($4) {
              return Data_Maybe_Last.Last(Data_Maybe.Just.create($4));
          });
          var $2 = Data_String_Common.split("/");
          return function ($3) {
              return $0($1($2($3)));
          };
      })();
      return Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)((function () {
          var $5 = Data_Either.note(Roll_API_Internal.UnknownError.value);
          return function ($6) {
              return $5(go($6));
          };
      })())(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(href)));
  })();
  var emptyElement = Halogen_HTML_Core.text("");
  var maybeElement = function (m) {
      return function (f) {
          return Data_Maybe.maybe(emptyElement)(f)(m);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.Component.Category"] = $PS["Roll.Component.Category"] || {};
  var exports = $PS["Roll.Component.Category"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Roll_API_Category = $PS["Roll.API.Category"];
  var Roll_Component_Internal = $PS["Roll.Component.Internal"];                
  var Initialize = (function () {
      function Initialize() {
  ...
  var renderProduct = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/produs/" + v.slug) ])([ Halogen_HTML_Core.text(v.name), Halogen_HTML_Core.text("de la " + Data_Show.show(Data_Show.showInt)(v.price)) ]), Halogen_HTML_Elements.p_([ Roll_Component_Internal.maybeElement(v.description)(Halogen_HTML_Core.text) ]) ]);
  };
  var render = function (v) {
      if (v.title instanceof Data_Maybe.Just && v.products instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.title.value0), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderProduct)(v.products.value0)) ]);
      };
      return Halogen_HTML_Core.text("loading...");
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Roll_Component_Internal.getSlug)(function (slug) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Roll_API_Category.getBySlug(slug))(function (title) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Roll_API_Category.getProducts(slug))(function (products) {
                      return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))({
                          products: new Data_Maybe.Just(products),
              ...
              if (v1 instanceof Data_Either.Left) {
                  return Data_Monoid.mempty(Halogen_Query_HalogenM.monoidHalogenM(Data_Monoid.monoidUnit));
              };
              if (v1 instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v1.value0);
              };
              throw new Error("Failed pattern match at Roll.Component.Category (line 68, column 13 - line 70, column 33): " + [ v1.constructor.name ]);
          });
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"]({
              ...
              products: Data_Maybe.Nothing.value
          }),
          render: render,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.API.Quote"] = $PS["Roll.API.Quote"] || {};
  var exports = $PS["Roll.API.Quote"];
  var Data_Show = $PS["Data.Show"];
  var Roll_API_Internal = $PS["Roll.API.Internal"];
  var Simple_JSON = $PS["Simple.JSON"];                
  var get = function (idx) {
      return Roll_API_Internal.get(Simple_JSON.readString)("/quote/" + Data_Show.show(Data_Show.showInt)(idx));
  };
  exports["get"] = get;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.Component.Hello"] = $PS["Roll.Component.Hello"] || {};
  var exports = $PS["Roll.Component.Hello"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Roll_API_Quote = $PS["Roll.API.Quote"];                
  var Initialize = (function () {
      function Initialize() {
  ...
  var render = Halogen_HTML_Core.text;
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Random.randomInt(0)(100)))((function () {
              var $9 = Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff));
              return function ($10) {
                  return $9(Control_Monad_Except_Trans.runExceptT(Roll_API_Quote.get($10)));
              };
          })()))(function (v1) {
              if (v1 instanceof Data_Either.Left) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)("Could not load quote.");
              };
              if (v1 instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
              };
              throw new Error("Failed pattern match at Roll.Component.Hello (line 41, column 17 - line 43, column 35): " + [ v1.constructor.name ]);
          }))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM));
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"]("loading quote..."),
          render: render,
          "eval": Halogen_Component.mkEval({
              handleAction: handleAction(dictMonadAff),
              handleQuery: Halogen_Component.defaultEval.handleQuery,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.API.ProductVariant"] = $PS["Roll.API.ProductVariant"] || {};
  var exports = $PS["Roll.API.ProductVariant"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Roll_API_Internal = $PS["Roll.API.Internal"];
  var Simple_JSON = $PS["Simple.JSON"];                
  var getProducts = function (slug) {
      return Roll_API_Internal.get(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "slug";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()())()())()())))("/product/" + slug);
  };
  exports["getProducts"] = getProducts;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Roll.Component.Product"] = $PS["Roll.Component.Product"] || {};
  var exports = $PS["Roll.Component.Product"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Roll_API_ProductVariant = $PS["Roll.API.ProductVariant"];
  var Roll_Component_Internal = $PS["Roll.Component.Internal"];                
  var Initialize = (function () {
      function Initialize() {
  ...
  var renderProduct = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Slug: " + v.slug), Halogen_HTML_Core.text(", name: " + v.name), Halogen_HTML_Core.text(", code: " + v.code), Halogen_HTML_Core.text(", price: " + Data_Show.show(Data_Show.showInt)(v.price)) ]), Halogen_HTML_Elements.p_([ Roll_Component_Internal.maybeElement(v.description)(Halogen_HTML_Core.text) ]) ]);
  };
  var render = function (v) {
      if (v.products instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderProduct)(v.products.value0));
      };
      return Halogen_HTML_Core.text("loading...");
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Roll_Component_Internal.getSlug)(Roll_API_ProductVariant.getProducts))))(function (v1) {
              if (v1 instanceof Data_Either.Left) {
                  return Data_Monoid.mempty(Halogen_Query_HalogenM.monoidHalogenM(Data_Monoid.monoidUnit));
              };
              if (v1 instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                      products: new Data_Maybe.Just(v1.value0)
                  });
              };
              throw new Error("Failed pattern match at Roll.Component.Product (line 58, column 13 - line 60, column 52): " + [ v1.constructor.name ]);
          });
      };
  };
  var component = function (dictMonadAff) {
...
(function($PS) {
  ...
  var Roll_Component_Category = $PS["Roll.Component.Category"];
  var Roll_Component_Hello = $PS["Roll.Component.Hello"];
  var Roll_Component_Product = $PS["Roll.Component.Product"];
  var Web_DOM_ParentNode = $PS["Web.DOM.ParentNode"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_HTMLDocument = $PS["Web.HTML.HTMLDocument"];
  var Web_HTML_HTMLElement = $PS["Web.HTML.HTMLElement"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];                
  var getElementById = function (s) {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))((function () {
          var $1 = Data_Functor.map(Effect.functorEffect)(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v)(Web_HTML_HTMLElement.fromElement);
          });
          var $2 = Web_DOM_ParentNode.querySelector(s);
          return function ($3) {
              return $1($2(Web_HTML_HTMLDocument.toParentNode($3)));
          };
      })()));
  };
  var runComponent = function (id) {
      return function (component) {
          return function (input) {
              return Control_Bind.bind(Effect_Aff.bindAff)(getElementById(id))(Data_Maybe.maybe(Data_Monoid.mempty(Effect_Aff.monoidAff(Data_Monoid.monoidUnit)))((function () {
                  var $4 = Data_Functor.voidRight(Effect_Aff.functorAff)(Data_Unit.unit);
                  var $5 = Halogen_VDom_Driver.runUI(component)(input);
                  return function ($6) {
                      return $4($5($6));
                  };
              })()));
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(runComponent("#roll-hello")(Roll_Component_Hello.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(runComponent("#roll-category")(Roll_Component_Category.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit))(function () {
          return runComponent("#roll-product")(Roll_Component_Product.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit);
      });
  }));
